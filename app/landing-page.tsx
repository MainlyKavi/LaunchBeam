...
const campaign = {
  ...
  description:
    "Northstar turns interviews and support calls into clear product decisions.",
  visitors: 4260,
  signups: 1108,
  conversion: "26.0%",
  referralSignups: 312,
...
function ProductStudio() {
  ...
  return (
    <div id="product" className="product-stage" data-reveal>
      <BrowserMockup title="Northstar campaign" className="studio-window">
            ...
            {activeTab === "page" ? (
              <div className="control-group">
                ...
                <div className="campaign-identity">
                  <span className="northstar-logo" aria-hidden="true">N</span>
                  <div>
  ...
  return (
    <div className="signup-demo">
      ...
      <form className="preview-signup" onSubmit={submit} noValidate>
        <label className="sr-only" htmlFor="northstar-preview-email">
          Example subscriber email
        </label>
        <input
          id="northstar-preview-email"
          type="email"
          autoComplete="off"
          placeholder="you@company.com"
          value={email}
          aria-invalid={status === "error"}
          aria-describedby="northstar-preview-status"
          onChange={(event) => {
